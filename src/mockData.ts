...
// Einsatzleitung für Spürhunde-Salzlandkreis e.V.
export const INITIAL_USERS: User[] = [
  {
    ...
    name: 'Maria',
    role: 'einsatzleitung',
    callSign: 'Einsatzleitung Maria',
    licensePlate: 'SLK-EL 1',
    phone: '+49 170 1234567',
    photoUrl: '',
    organization: 'Spürhunde-Salzlandkreis e.V.',
    equipment: ['first_aid'],
    customEquipmentNotes: 'Einsatzleitung & Koordination',
    isActive: false,
    batteryLevel: 100,
    lastSeen: 'Online',
  },
  ...
  },
  {
    ...
    name: 'Jens',
    role: 'einsatzleitung',
    callSign: 'Einsatzleitung Jens',
    licensePlate: 'SLK-EL 2',
    phone: '+49 170 2345678',
    photoUrl: '',
    organization: 'Spürhunde-Salzlandkreis e.V.',
    equipment: ['first_aid'],
    customEquipmentNotes: 'Einsatzleitung & Lagekarte',
    isActive: false,
    batteryLevel: 100,
    lastSeen: 'Abgemeldet',
  },
  {
    ...
    name: 'Micha',
    role: 'einsatzleitung',
    callSign: 'Einsatzleitung Micha',
    licensePlate: 'SLK-EL 3',
    phone: '+49 170 3456789',
    photoUrl: '',
    organization: 'Spürhunde-Salzlandkreis e.V.',
    equipment: ['first_aid'],
    customEquipmentNotes: 'Einsatzleitung & EZ',
    isActive: false,
    batteryLevel: 100,
    lastSeen: 'Abgemeldet',
  },
